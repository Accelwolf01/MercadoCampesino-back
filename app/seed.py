...
def seed_data(db: Session):
    ...
    permisos_data = [
        ...
        {"nombre": "Gestionar usuarios", "codigo": "gestionar_usuarios", "descripcion": "Activar, bloquear, ver historial de usuarios"},
        {"nombre": "Realizar preorden", "codigo": "realizar_preorden", "descripcion": "Apartar productos antes de ir a la plaza"},
        {"nombre": "Ver preordenes", "codigo": "ver_preordenes", "descripcion": "Ver pedidos apartados por consumidores"},
    ]
    permisos = {}
    ...
    db.execute(perfiles_permisos.insert().values([
        ...
        {"id_perfil": perfiles["superadmin"].id, "id_permiso": permisos["gestionar_usuarios"].id},
        ...
        {"id_perfil": perfiles["administrador"].id, "id_permiso": permisos["gestionar_usuarios"].id},
